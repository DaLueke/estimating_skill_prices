...
% TODO: Add plot with optimal task choices to show that these are (1) not in the extremes and contain no corner solutions. (2) they are centered in the middle of the distribution, accounting for the slightly higher p rices in task 2 of course, so slightly skewed dist towards task 2. 
